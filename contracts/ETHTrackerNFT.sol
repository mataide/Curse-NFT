...
contract ETHTrackerNFT is ERC721Upgradeable {
    ...
    function initialize(string memory baseURI, address priceFeedOracle) public initializer
    {
        __ERC721_init("ETHTrackerNFT", "ETN");
        _base = baseURI;
